...
class BasicInformationModel(models.Model):
    ...
    one_to_fivehundred = models.CharField(max_length = 3, default='', blank=True,null = True)
    fivehundred_to_1000 = models.CharField(max_length = 3, default='', blank=True,null = True)
    one_two_thousand = models.CharField(max_length = 3, default='', blank=True,null = True)
    two_four_thousand = models.CharField(max_length = 3, default='', blank=True,null = True)
    more4000 = models.CharField(max_length = 3, default='', blank=True, null = True)
    vegetable = models.CharField(max_length = 3, default='', blank=True, null = True)
    poultry = models.CharField(max_length = 3, default='', blank=True, null = True)
    goat = models.CharField(max_length = 3, default='', blank=True, null = True)
    fisheries = models.CharField(max_length = 3, default='', blank=True, null = True)
    others = models.CharField(max_length = 3, default='', blank=True, null = True)
