...
class financialExpensesModel(models.Model):
    user = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, default = 1)
    soilPrep = models.CharField(max_length = 100, blank=True,null = True)
    fertilizers = models.CharField(max_length = 100, blank=True,null = True)
    seeds = models.CharField(max_length = 100, blank=True,null = True)
    cultTools = models.CharField(max_length = 100, blank=True,null = True)
    ...
    labor = models.CharField(max_length = 100, blank=True,null = True)
    irrigation = models.CharField(max_length = 100, blank=True,null = True)
    miscellaneous = models.CharField(max_length = 100, blank=True,null = True)